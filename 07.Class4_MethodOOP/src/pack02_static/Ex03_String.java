...
public class Ex03_String {
	...
	public static void main(String[] args) {
		...
		//supString() : 특정문자 추출(index)
		//subString메소드를 코드 자동완성(ctrl+space)로 해보고 호출해보기
		System.out.println("subString(int) : "+ str1.substring(2));//내가 준 index0부터 문자열 끝까지 출력
		System.out.println("subString(int,int) : "+ str1.substring(0,3));//index 1부터 3의 앞까지 추출
		...
		//replaceAll():문자열 치환(특정문자를 바꿔서 원하는 문자로 바꾸는 것) A=>X
		//PP라는 글자를 찾아서 @@바꿔보기
		System.out.println(str1.replaceAll("p","@"));//return타입?String?
		...
		System.out.print("eqStr1과 eqStr2는 ");
