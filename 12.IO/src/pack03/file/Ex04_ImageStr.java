...
public class Ex04_ImageStr {
	...
	public static void main(String[] args) throws IOException {
		FileInputStream fis= new FileInputStream("D:\\Study_java\\WorkSpace\\12_IO_FileTest\\pic.jpg");
		FileOutputStream fos= new FileOutputStream("D:\\Study_java\\WorkSpace\\12_IO_FileTest\\pic_copy.jpg");
		int data,cnt=0; //data: byte단위로 쪼개진 데이터를 하나씩 읽어와서 저장, cnt는 몇번이나 파일을 읽는지
		while((data=fis.read())!=-1) {//-1:file이 없다, -1이 아니면 파일 내부에 데이터가 있다.
			cnt++;
