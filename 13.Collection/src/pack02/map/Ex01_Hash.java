...
public class Ex01_Hash {
	public static void main(String[] args) {
		//Collection자료구조는 <>클래스타입만 넣을 수 있게 구조가 되어있음
...
//		System.out.println(strHash3.hashCode());
		...
		set.add("jsp/servlet");
		set.add("oracledb");
		set.add("java");//HashSet은 해시코드로 비교하여 중복된 데이터가 있다면 마지막 데이터만 유지가됨.
						//데이터 건수가 몇건일까??
		
		System.out.println("내부에 들어있는 아이템 개수 :"+set.size());
	
		//HashSet 자료구조는 index로 접근을 하는게 아니라 요소별로 접근을 하는것을 권장함
		...
		//반복횟수가 정확하게 정해지지 않거나 인덱스로 관리가 안될때는 '향상된for문'이 편함
